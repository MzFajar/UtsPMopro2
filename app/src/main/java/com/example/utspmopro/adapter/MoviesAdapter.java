package com.example.utspmopro.adapter;
...
import com.example.utspmopro.activity.DetailMovieActivity;
import com.example.utspmopro.model.Movie;
...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int
        ...
        holder.cvMovie.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) { Intent i =new Intent(context, DetailMovieActivity.class);
